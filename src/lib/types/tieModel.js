export class TieModel {
  ...
  constructor(dataView, offset) {
    ...
    //const off_20 = readUInt32BE(offs + 0x20);
    ...
    //const off_2c = readFloat(buff,offs + 0x2c);
    ...
    for (let i = 0; i < textureCount; i++) {
      const textureOffset = texturePointer + i * 0x18;

      const textureId = dataView.getInt32(textureOffset + 0x00);
      const faceIndex = dataView.getUint32(textureOffset + 0x08);
      const faceCount = dataView.getUint32(textureOffset + 0x0c);
